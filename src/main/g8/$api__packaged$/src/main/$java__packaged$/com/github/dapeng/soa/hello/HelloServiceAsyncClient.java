package com.github.dapeng.soa.hello;
      ...
      import com.github.dapeng.soa.hello.HelloServiceCodec.*;
 ...
 *  @generated
      ...
      **/
      ...
      public HelloServiceAsyncClient() {
        this.serviceName = "com.github.dapeng.soa.hello.service.HelloService";
        this.version = "1.0.0";
        ...
        this.pool.registerClientInfo(serviceName,version);
            ...
            **/
              ...
              public CompletableFuture<String> sayHello(com.github.dapeng.soa.hello.domain.Hello hello, long timeout) throws SoaException{
