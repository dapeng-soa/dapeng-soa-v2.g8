package com.github.dapeng.soa.hello;
      ...
      public void validate(sayHello_result bean) throws TException{
            ...
            public static class sayHello<I extends com.github.dapeng.soa.hello.service.HelloServiceAsync> extends SoaFunctionDefinition.Async<I, sayHello_args, sayHello_result>
            {
              public sayHello()
              {
      ...
      public void validate(test_result bean) throws TException{
            ...
            public static class test<I extends com.github.dapeng.soa.hello.service.HelloServiceAsync> extends SoaFunctionDefinition.Async<I, test_args, test_result>
            {
              public test()
              {
        ...
        public static class Processor<I extends com.github.dapeng.soa.hello.service.HelloServiceAsync> extends SoaServiceDefinition<com.github.dapeng.soa.hello.service.HelloServiceAsync>
        {

          public Processor(com.github.dapeng.soa.hello.service.HelloServiceAsync iface, Class<com.github.dapeng.soa.hello.service.HelloServiceAsync> ifaceClass)
          {
            super(iface, ifaceClass, buildMap(new java.util.HashMap<>()));
          }

          @SuppressWarnings("unchecked")
          private static <I extends com.github.dapeng.soa.hello.service.HelloServiceAsync> java.util.Map<String, SoaFunctionDefinition<I, ?, ?>> buildMap(java.util.Map<String, SoaFunctionDefinition<I, ?, ?>> processMap)
          {
