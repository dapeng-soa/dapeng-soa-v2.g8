...
override def validate(bean: sayHello_result): Unit = {
    ...
    class sayHello extends SoaFunctionDefinition.Async[com.github.dapeng.hello.scala.service.HelloServiceAsync, sayHello_args, sayHello_result]("sayHello", new SayHello_argsSerializer(), new SayHello_resultSerializer()){

    @throws[TException]
    def apply(iface: com.github.dapeng.hello.scala.service.HelloServiceAsync, args: sayHello_args):Future[sayHello_result] = {
...
class getServiceMetadata extends SoaFunctionDefinition.Async[com.github.dapeng.hello.scala.service.HelloServiceAsync, getServiceMetadata_args, getServiceMetadata_result](
"getServiceMetadata", new GetServiceMetadata_argsSerializer(), new GetServiceMetadata_resultSerializer()) {


  @throws[TException]
  override def apply(iface: com.github.dapeng.hello.scala.service.HelloServiceAsync, args: getServiceMetadata_args): Future[getServiceMetadata_result] = {
...
class Processor(iface: com.github.dapeng.hello.scala.service.HelloServiceAsync) extends
SoaServiceDefinition(iface,classOf[com.github.dapeng.hello.scala.service.HelloServiceAsync], Processor.buildMap)

object Processor{

  type PF = SoaFunctionDefinition[com.github.dapeng.hello.scala.service.HelloServiceAsync, _, _]
