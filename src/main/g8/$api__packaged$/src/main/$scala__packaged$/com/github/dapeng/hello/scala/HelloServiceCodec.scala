...
object HelloServiceCodec {
    ...
    case class sayHello_args(hello:com.github.dapeng.hello.scala.domain.Hello)
...
var hello: com.github.dapeng.hello.scala.domain.Hello = null
...
schemeField.id match {
      ...
      case 1 =>
          schemeField.`type` match {
            case com.github.dapeng.org.apache.thrift.protocol.TType.STRUCT => hello = new com.github.dapeng.hello.scala.domain.serializer.HelloSerializer().read(iprot)
...
oprot.writeStructBegin(new com.github.dapeng.org.apache.thrift.protocol.TStruct("sayHello_args"))
    ...
    oprot.writeFieldBegin(new com.github.dapeng.org.apache.thrift.protocol.TField("hello", com.github.dapeng.org.apache.thrift.protocol.TType.STRUCT, 1.asInstanceOf[Short]))
     new com.github.dapeng.hello.scala.domain.serializer.HelloSerializer().write(elem0, oprot)
    oprot.writeFieldEnd
...
override def validate(bean: sayHello_args): Unit = {
      ...
      throw new SoaException(SoaBaseCode.NotNull, "hello字段不允许为空")
        ...
        if(bean.hello != null)
        new com.github.dapeng.hello.scala.domain.serializer.HelloSerializer().validate(bean.hello)
...
override def validate(bean: sayHello_result): Unit = {
    ...
    class sayHello extends SoaFunctionDefinition.Sync[com.github.dapeng.hello.scala.service.HelloService, sayHello_args, sayHello_result]("sayHello", new SayHello_argsSerializer(), new SayHello_resultSerializer()){

    @throws[TException]
    def apply(iface: com.github.dapeng.hello.scala.service.HelloService, args: sayHello_args):sayHello_result = {
...
class getServiceMetadata extends SoaFunctionDefinition.Sync[com.github.dapeng.hello.scala.service.HelloService, getServiceMetadata_args, getServiceMetadata_result](
"getServiceMetadata", new GetServiceMetadata_argsSerializer(), new GetServiceMetadata_resultSerializer()) {


@throws[TException]
override def apply(iface: com.github.dapeng.hello.scala.service.HelloService, args: getServiceMetadata_args): getServiceMetadata_result = {

      val source = scala.io.Source.fromInputStream(HelloServiceCodec.getClass.getClassLoader.getResourceAsStream("com.github.dapeng.hello.service.HelloService.xml"))
...
class Processor(iface: com.github.dapeng.hello.scala.service.HelloService) extends
SoaServiceDefinition(iface,classOf[com.github.dapeng.hello.scala.service.HelloService], Processor.getProcessMap)

object Processor{

  type PF = SoaFunctionDefinition[com.github.dapeng.hello.scala.service.HelloService, _, _]
